...
impl DbCrate {
    ...
    /// The lexing rules the generated runtime compiles the query with.
    pub(crate) fn runtime_dialect(self) -> crate::dynfilter_runtime::Dialect {
        use params_common::ParamsGenerator as _;
        match self {
            Self::Sqlx(sqlx) => sqlx.dialect(),
            Self::Rusqlite => rusqlite::Rusqlite.dialect(),
