...
mod tests {
    ...
    #[tokio::test]
    async fn lists_authors_by_ids(ctx: &mut SqlxMysqlContext) {
        let pool = &ctx.pool;
    ...
    #[test_context(SqlxMysqlContext)]
    #[tokio::test]
    async fn lists_authors_by_two_id_lists(ctx: &mut SqlxMysqlContext) {
        let pool = &ctx.pool;
        migrate_db(pool).await;
        seed_authors(pool).await;
    ...
    #[test_context(SqlxMysqlContext)]
    #[tokio::test]
    async fn lists_authors_by_ids_mixed(ctx: &mut SqlxMysqlContext) {
        let pool = &ctx.pool;
        migrate_db(pool).await;
        seed_authors(pool).await;
