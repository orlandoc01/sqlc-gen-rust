...
impl<'r> sqlx::FromRow<'r, sqlx::mysql::MySqlRow> for GetAuthorRow {
...
impl<'r> sqlx::FromRow<'r, sqlx::mysql::MySqlRow> for ListAuthorsRow {
    fn from_row(row: &'r sqlx::mysql::MySqlRow) -> Result<Self, sqlx::Error> {
        Ok(Self {
            id: sqlx::Row::try_get(row, 0)?,
            name: sqlx::Row::try_get(row, 1)?,
...
impl<'r> sqlx::FromRow<'r, sqlx::mysql::MySqlRow> for CountAuthorsRow {
    fn from_row(row: &'r sqlx::mysql::MySqlRow) -> Result<Self, sqlx::Error> {
        Ok(Self {
