...
{
    client.prepare_cached(GET_SYNC_ENTRY).await
}
pub async fn get_sync_entry(
    client: &impl deadpool_postgres::GenericClient,
    state: Sync,
) -> Result<GetSyncEntryRow, deadpool_postgres::tokio_postgres::Error> {
...
pub async fn get_sync_entry_opt(
    client: &impl deadpool_postgres::GenericClient,
    state: Sync,
) -> Result<Option<GetSyncEntryRow>, deadpool_postgres::tokio_postgres::Error> {
...
pub async fn search_sync_entries(
    client: &impl deadpool_postgres::GenericClient,
    params: SearchSyncEntriesParams,
) -> Result<Vec<SearchSyncEntriesRow>, deadpool_postgres::tokio_postgres::Error> {
