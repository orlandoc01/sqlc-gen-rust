...
{
    client.prepare_cached(UPDATE_KNOWN_TYPES).await
}
pub async fn update_known_types(
    ...
    let values: &[(
        ...
        (
            &params.bool_array_val,
            deadpool_postgres::tokio_postgres::types::Type::BOOL_ARRAY,
        ),
        (
            &params.timestamptz_val,
            deadpool_postgres::tokio_postgres::types::Type::TIMESTAMPTZ,
        ),
        (
            &params.timestamp_val,
            deadpool_postgres::tokio_postgres::types::Type::TIMESTAMP,
        ),
        (
            &params.date_val,
            deadpool_postgres::tokio_postgres::types::Type::DATE,
        ),
        (
            &params.uuid_val,
            deadpool_postgres::tokio_postgres::types::Type::UUID,
        ),
        (
            &params.json_val,
            deadpool_postgres::tokio_postgres::types::Type::JSON,
        ),
        (
            &params.jsonb_val,
        ...
        (
            &params.bytea_val,
            deadpool_postgres::tokio_postgres::types::Type::BYTEA,
        ),
        (
            &params.text_val,
        ...
        (
            &params.bool_val,
            deadpool_postgres::tokio_postgres::types::Type::BOOL,
        ),
        (
            &params.double_val,
            deadpool_postgres::tokio_postgres::types::Type::FLOAT8,
        ),
        (
            &params.id,
